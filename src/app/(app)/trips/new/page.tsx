  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!gpxData) {
      toast({
        ...
        description: "Please upload a GPX file for your trip route.",
        variant: "destructive",
      });
      return;
    }
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter the basic information for your new bicycle tour.
            </CardDescription>
          </CardHeader>
